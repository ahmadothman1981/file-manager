    ...
    <thead class="bg-grey-100 border-b ">
        ...
        <tr v-for="file of allFiles.data" :key="file.id" @dblclick="openFolder(file)" @click="$event => toggleFileSelect(file)">
          ...
          :class="(selected[file.id] || allSelected) ? 'bg-blue-50' : 'bg-white'">
            ...
            <td class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100  text-yellow-500">
          <div @click.stop.prevent="addRemoveFavourite(file)">
              <svg v-if="!file.is_favourite" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
